...
const BriefForm: React.FC<BriefFormProps> = ({ onSubmit, isSubmitting }) => {
   ...
   * Adds smooth fade-in when text appears
   */
  ...
  // Helper function to get textarea/input className with animation
  const getFieldClassName = (fieldName: string, baseClasses: string) => {
    const isAnimating = animatingField === fieldName;
    return `${baseClasses} ${isAnimating ? 'animate-fadeIn' : ''}`;
  };
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="relative z-10 glass-panel rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden">
          ...
          <div className="text-center mb-16 relative">
            <h1 className="text-4xl md:text-5xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-slate-300 drop-shadow-sm">
              ✨ Smart Studio
            </h1>
            <p className="text-slate-400 font-light text-lg">
              תאר מה אתה רוצה ליצור, וה-AI יעשה את השאר
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-16">
            ...
            <section>
               <div className="flex items-center gap-5 mb-8">
                 ...
                 <h2 className={sectionHeaderClasses}>השראה (אופציונלי)</h2>
              </div>
                 ...
                 <div className="text-center py-6 border-2 border-dashed border-white/10 rounded-xl hover:border-fuchsia-500/50 transition-all">
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer inline-flex flex-col items-center gap-3 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 rounded-xl transition-all text-sm font-bold group-hover:text-white group-hover:border-white/20">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-500">תמונות או PDF</div>
                      </div>
                    </label>
                 </div>
              </div>
            ...
            <div className="text-center">
              <button
                ...
                className="text-sm font-bold text-slate-300 hover:text-fuchsia-400 transition-all flex items-center gap-3 bg-slate-800/30 hover:bg-slate-800/50 px-4 py-3 rounded-lg border border-white/10 hover:border-fuchsia-500/30 mx-auto"
              >
                <span className="text-lg">{showAdvanced ? '▼' : '▶'}</span>
                <span>אפשרויות מתקדמות (אופציונלי)</span>
              </button>
            </div>
            ...
            {showAdvanced && (
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                   {/* Essential Info Field */}
                   <div className="col-span-1 md:col-span-2">
                    <label className={labelClasses}>מה לכתוב על העיצוב? 📝</label>
                    <textarea 
                      name="essentialInfo" 
                      value={formData.essentialInfo} 
                      onChange={handleInputChange} 
                      className={getFieldClassName('essentialInfo', `${inputClasses} h-28`)}
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={handleInputChange} 
                      className={getFieldClassName('targetAudience', inputClasses)}
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      value={formData.goal} 
                      onChange={handleInputChange} 
                      className={getFieldClassName('goal', inputClasses)}
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={handleInputChange} 
                      className={getFieldClassName('callToAction', inputClasses)}
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={handleInputChange} 
                      className={getFieldClassName('coreMessage', `${inputClasses} h-24`)}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {platformOptions.map(platform => (
                  ...
                  >
                    ...
                    <div className="font-bold text-base mb-1 group-hover:text-white transition-colors">{platform.label}</div>
