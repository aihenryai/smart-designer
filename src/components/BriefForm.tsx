...
const BriefForm: React.FC<BriefFormProps> = ({ onSubmit, isSubmitting }) => {
  ...
  // Refs to track field elements for animation
  const fieldRefs = useRef<{ [key: string]: HTMLTextAreaElement | HTMLInputElement | null }>({});
  ...
  const getFieldClassName = (fieldName: string, baseClasses: string) => {
    ...
    return `${baseClasses} ${isLoading ? 'opacity-50' : 'opacity-100'} ${
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-r-4 border-pink-500">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ref={(el) => (fieldRefs.current['essentialInfo'] = el)}
                  name="essentialInfo"
                  ...
                  className={getFieldClassName(
                    'essentialInfo',
                    'w-full px-4 py-3 border-2 border-pink-300 rounded-lg focus:border-pink-500 focus:ring-2 focus:ring-pink-200 transition-all'
                  )}
              ...
              <div>
                ...
                <input
                  ...
                  className={getFieldClassName(
                    'targetAudience',
                    'w-full px-4 py-3 border-2 border-pink-300 rounded-lg focus:border-pink-500 transition-all'
                  )}
              ...
              <div>
                ...
                <input
                  ref={(el) => (fieldRefs.current['callToAction'] = el)}
                  type="text"
                  name="callToAction"
              ...
              <div>
                ...
                <textarea
                  ref={(el) => (fieldRefs.current['coreMessage'] = el)}
                  name="coreMessage"
